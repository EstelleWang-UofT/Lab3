...
//            one more language code of your choice.("fr") Each member of your group should add
...
public class InLabByHandTranslator implements Translator {
    ...
    public String translate(String country, String language) {
        ...
        List<String> availableCountryLanguages = getCountryLanguages(country);

        if (!CANADA.equals(country) || !availableCountryLanguages.contains(language)) {
            return null;
        }
        else {
            JSONTranslationExample jsonTranslationExample = new JSONTranslationExample();
            return jsonTranslationExample.getCountryNameTranslation(CANADA, language);
        }
    }
}
